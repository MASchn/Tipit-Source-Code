//
//  TIPEditProfileTableViewCell.swift
//  Ironc.ly
//

import UIKit

protocol TIPEditProfileCellDelegate: class {
    func finishedTyping(cell: TIPEditProfileTableViewCell)
}

class TIPEditProfileTableViewCell: UITableViewCell {
    
    // MARK: - Properties
    weak var delegate: TIPEditProfileCellDelegate?
...
extension TIPEditProfileTableViewCell: UITextFieldDelegate {
