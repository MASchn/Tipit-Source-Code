//
//  TIPEditProfileHeaderView.swift
//  Ironc.ly
//

import UIKit

protocol TIPEditProfileHeaderViewDelegate: class {
    func tappedChangeProfileButton()
    func tappedChangeBackgroundButton()
}

class TIPEditProfileHeaderView: UIView {
    
    // MARK: - Properties
    weak var delegate: TIPEditProfileHeaderViewDelegate?
