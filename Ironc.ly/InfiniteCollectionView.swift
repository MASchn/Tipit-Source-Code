...
//  Ironc.ly
//
//  Created by Alex Laptop on 9/3/17.
...
//    }
    ...
    required init(frame : CGRect, layout: UICollectionViewFlowLayout) {
        super.init(frame: frame, collectionViewLayout: layout)
        dataSource = self
        delegate = self
        setupCellDimensions(layout: layout)
    }
    ...
    fileprivate func setupCellDimensions(layout: UICollectionViewFlowLayout)
    {
