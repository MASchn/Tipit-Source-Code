...
class IROPhotoCaptureDelegate: NSObject, AVCapturePhotoCaptureDelegate {
    ...
    private let completed: (IROPhotoCaptureDelegate) -> ()
    
    private var photoData: Data? = nil
    
    private var livePhotoCompanionMovieURL: URL? = nil
    
    init(with requestedPhotoSettings: AVCapturePhotoSettings, willCapturePhotoAnimation: @escaping () -> (), capturingLivePhoto: @escaping (Bool) -> (), completed: @escaping (IROPhotoCaptureDelegate) -> ()) {
